...
class Venta(models.Model):
    ...
    formadepago = models.CharField(max_length=50, verbose_name="Forma de pago")
    cantidad = models.IntegerField(verbose_name="Cantidad de bicis")
...
class Reparacion(models.Model):
    ...
    idBici = models.ForeignKey(Bici, on_delete=models.CASCADE, verbose_name="Id de la bici")
    cliente = UserForeignKey(auto_user_add=True, verbose_name="cliente")
    fecha = models.DateField(verbose_name="Fecha de la reparacion")
...
class despacho(models.Model):
    ...
    fecha = models.DateField(verbose_name="Fecha del despacho")
    fechaTermino = models.DateField(verbose_name="Fecha de termino del despacho") 
